...
const projects = [
    {
        ...
        description: `This was my first foray into React/ Next.js and also into utilising APIs. My Video Game Database (MGDb), is a IMDb"-esque" web-app but specifically for video games. The apps includes features such as, search, filter and sort games from the API's lists as well as the ability to select games to view more details, for example: release date, platform(s), a short description and cover images. `,
        more: `The app currently gets data from REST API supported by Twitch. The data sorting and filtering is done on the client side / front end. I want to move the data onto my own database and make the client GET this data from my own database, depending on the user's form input selection.
    ...
    },
    {
        ...
        title: 'Zen Rally',
        img: 'https://private-user-images.githubusercontent.com/41272270/273391163-67aad3ab-3dff-4b43-81ab-f3b09cd2b394.png?jwt=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..DFdQRPJYKEtE8_F_dooSRWRRRW_wQJiGEru5k-xlfqA',
        description: `Zen Rally is a driving mini-game built using the Unity Game Engine and C#. Realistic vehicle physics and calming snowy environment, encourage the player to to get into the flow state of rally driving. My educational background is in Mechanical and Automotive Engineering, so I decided to build a vehicle controller from scratch in Unity using C# to create the vehicle physics equations and apply these forces to the car model. `,
        more: `This mini project has helped expose me to the syntax and structure of another language, in this case C#. It has also provided an opportunity to develop software outside of web development.
